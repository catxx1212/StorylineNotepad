...
if (!localStorage.getItem("storylineNotepad_global")) {
  ...
  //     appendTimeAndDateToFileExport: "enabled",
  //     defaultFallbackTheme: "white",                            // this works fine, it just resets user prefrenseses without using the UI object. The one in storyline notepad maoin still checks so theres no harm in leaving this out.
  //     autoExportWhenImporting: "enabled",
  //     textAlign: "center",     
  //   };
